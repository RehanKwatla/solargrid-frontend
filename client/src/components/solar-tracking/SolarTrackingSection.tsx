...
export function SolarTrackingSection() {
  ...
  return (
    <div className="w-full min-w-0 flex flex-col border border-border bg-surface rounded-lg overflow-hidden">
      {/* 3D Viewport */}
      <div className="relative w-full min-w-0 bg-[#a8c8d8] dark:bg-[#1a2e1c]">
        <SolarTracking3D />
        ...
        <div className="absolute right-3 top-3 flex items-center gap-1.5 pointer-events-none z-10">
      ...
      {/* Stats Panel */}
      <div className="w-full min-w-0 border-t border-border bg-surface p-4 sm:p-5 flex flex-col justify-between">
        <SolarTrackingStats />
