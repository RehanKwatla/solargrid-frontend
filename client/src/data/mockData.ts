...
export const mockHospitalLoads = [
  ...
  // Emergency & Trauma (Critical / High)
  {
    id: "load-emg-01",
    facility_id: "SG-ACC-01",
  ...
  // Cold Chain & Vaccine Hub (Critical)
  {
    id: "load-cold-01",
    facility_id: "SG-ACC-01",
  ...
  // General Inpatient Wards (Normal)
  {
    id: "load-wrd-01",
    facility_id: "SG-ACC-01",
  ...
  // Administrative & Utilities (Non-Critical)
  {
    id: "load-adm-01",
    facility_id: "SG-ACC-01",
